<template>
              ...
              <div class="overlap-group-wrapper">
                <div class="div">
                  <div class="frame-2">
                    <div class="frame-3">
                      <div class="text-wrapper">Chatbot Pricing</div>
                      <p class="p">Start building your Chatbot for free. Upgrade to unlock more features.</p>
                    </div>
                    <div class="frame-4">
                      <div class="div-wrapper">
                        <div class="overlap-group-2">
                          <div class="frame-5">
                            <div class="frame-6">
                              <!-- <div class="text-wrapper-2">Try for Free</div> -->
                              <router-link class="text-wrapper-2" to="/login">Try for Free</router-link>

                            </div>
                            <div class="frame-7"><div class="text-wrapper-3">Free</div></div>
                            <div class="auto-layout"><div class="text-wrapper-4">$0</div></div>
                            <div class="frame-8">
                              <div class="frame-9">
                                <img class="img" src="img/frame-33.svg" />
                                <div class="text-wrapper-5">1 chatbot</div>
                              </div>
                              <div class="frame-10">
                                <img class="img" src="img/frame-32.svg" />
                                <div class="text-wrapper-6">Upload multiple files</div>
                              </div>
                              <div class="frame-11">
                                <img class="img" src="img/frame-31.svg" />
                                <div class="text-wrapper-6">30 message credits/month</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="overlap-group-2">
                          <div class="frame-13">
                            <div class="overlap-group-3">
                              <div class="frame-14">
                                <!-- <div class="text-wrapper-8">Get Plan</div> -->
                                <router-link class="text-wrapper-2" to="/login">Try for Free</router-link>

                              </div>
                              <div class="frame-15"><div class="text-wrapper-9">Standard</div></div>
                              <div class="auto-layout"><div class="text-wrapper-10">$99</div></div>
                              <div class="frame-16">
                                <div class="frame-17">
                                  <img class="img" src="img/frame-30.svg" />
                                  <div class="text-wrapper-11">5 chatbots</div>
                                </div>
                                <div class="frame-18">
                                  <img class="img" src="img/frame-29.svg" />
                                  <div class="text-wrapper-6">10,000 message credits/month</div>
                                </div>
                                <div class="frame-19">
                                  <img class="img" src="img/frame-28.svg" />
                                  <div class="text-wrapper-6">Embed on unlimited websites</div>
                                </div>
                              </div>
                            </div>
                          </div>
