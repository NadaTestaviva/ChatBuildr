    ...
    <div id="upload" class="pt-10 md:py-16 lg:py-24 overflow-hidden">
      <div class="max-w-screen-xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <p>Add your data sources to train your chatbot</p>
                  ...
                  <!-- Title -->
          <div style="text-align: start;" class="py-5">
            <label for="title" class="px-3 text-sm font-medium text-gray-700"
              >Chatbot Name *</label>
            <input
              type="text"
              name="name"
...
<script>
 ...
 export default {
  ...
  formSubmit(e) {
      ...
      if(this.text === ""){
          alert('Please Enter Valid Chatbot Name');
          return;
      }
      e.preventDefault();
      let currentObj = this;
      ...
      formData.append('chatbotName',this.text);
