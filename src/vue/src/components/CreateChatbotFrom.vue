<template>
    <div id="upload" class="pt-10 md:py-16 lg:py-24 overflow-hidden">
      <div class="max-w-screen-xl mx-auto text-center px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div class="relative z-20 text-center">
                  ...
                  <form @submit="formSubmit" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <button style="  float: inline-end; background:black" class="rounded-md bg-indigo-600 px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
                        <br><br>
                      </form>
        ...
        <!-- <button type="submit" style="  float: inline-end; background:black" class="rounded-md bg-indigo-600 px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            <router-link to="/create-chatbot">Submit</router-link>

          </button>    -->
        <p class="text-xs text-left text-gray-500 px-2 my-1">
          Upload icon made by <a href="https://www.flaticon.com/free-icon/cloud-computing_957907" title="Kiranshastry">Kiranshastry</a> from <a href="https://www.flaticon.com/" title="Flaticon"> www.flaticon.com</a>
        </p>
      </div>
    </div>
</template>
...
<script>
 ...
 export default {
  ...
  methods: {
      ...
      //   const url = "http://localhost:8000/uploaddoc";
      //   alert(formData.data.file);
      //   axios.get(url , formData ,{ headers }).then((res) => {
      //     alert(res);
